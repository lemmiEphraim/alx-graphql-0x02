...
const Home: React.FC = () => {
  ...
  if (loading) return <h1 className="text-center text-2xl mt-8">Loading...</h1>
  if (error) return <h1 className="text-center text-2xl text-red-500 mt-8">Error: {error.message}</h1>
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A3D5E0] to-[#F4F4F4] text-gray-800">
      ...
      <main className="flex-grow p-6">
        ...
        <div className="flex justify-between mt-6">
          ...
          <span className="text-lg font-semibold self-center">Page {page} of {info?.pages}</span>
          <button 
